...
inference(spain12$response, est = "proportion", type = "ci", method = "theoretical", 
          success = "atheist")
```
**The Spain hasnt seen a change in its atheism, as there is no significant differences between 2005 and 2012 for both Atheist and Non- Atheist**
   **b.** Is there convincing evidence that the United States has seen a
    change in its atheism index between 2005 and 2012?
```{r}
us12 <- subset(atheism, nationality == "United States" & year == "2012")
us05 <- subset(atheism, nationality == "United States" & year == "2012")
...
inference(us05$response, est = "proportion", type = "ci", method = "theoretical", 
          success = "atheist")
```
**  The United States hasnt seen a change in its atheism, as there is no significant differences between 2005 and 2012 for both Atheist and Non- Atheist**
...
# Since we have no prior knowledge of the proportion, we therefore use, 
