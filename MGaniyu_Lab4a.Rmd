...
**The mean of samp2 would be almost the same with the mean of samp1.**
...
**The samp4, with 100 sample will have the accurate mean, as the large the sample mean the accurate it becomes and closer to the population mean.**
...
**I wont expect the distribution to change if instead collected 50,000 sample.**
...
**The sampling distribution for the size of 50 is thesame as that of 150, with mean around 180000.**
